...
class HandleCollisionsAction(Action):
    ...
    def _handle_segment_collision(self, cast):
        ...
        second_head = second_cycle.get_segments()[0]
        segments = cycle.get_segments()[1:]
        second_cycle_segments = second_cycle.get_segments()[1:]
        
        for segment in segments:
            if head.get_position().equals(segment.get_position()):
                self._is_game_over = True
        
        for segment in second_cycle_segments:
    ...
    def _handle_game_over(self, cast):
        ...
        if self._is_game_over:
            ...
            second_cycle_segments = second_cycle.get_segments()
